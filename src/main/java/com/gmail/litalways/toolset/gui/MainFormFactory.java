...
public class MainFormFactory implements ToolWindowFactory {
    ...
    public void createToolWindowContent(@NotNull Project project, @NotNull ToolWindow toolWindow) {
        ...
        Content toolWindowConvertContent = contentFactory.createContent(toolWindowConvert.getContent(), messageBundle.getString("convert.tab.title"), true);
        ...
        Content toolWindowEncryptContent = contentFactory.createContent(toolWindowEncrypt.getContent(), messageBundle.getString("encrypt.tab.title"), false);
        ...
        Content toolWindowQRCodeContent = contentFactory.createContent(toolWindowQRCode.getContent(), messageBundle.getString("qr.tab.title"), false);
        ...
        Content toolWindowFormatContent = contentFactory.createContent(toolWindowFormat.getContent(), messageBundle.getString("format.tab.title"), false);
        ...
        Content toolWindowScriptContent = contentFactory.createContent(toolWindowScript.getContent(), messageBundle.getString("script.tab.title"), false);
        ...
        Content toolWindowSymbolContent = contentFactory.createContent(toolWindowSymbol.getContent(), messageBundle.getString("symbol.tab.title"), false);
        ...
        Content toolWindowOtherContent = contentFactory.createContent(toolWindowOther.getContent(), messageBundle.getString("other.tab.title"), false);
